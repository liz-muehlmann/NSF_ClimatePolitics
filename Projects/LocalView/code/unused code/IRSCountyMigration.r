...
## load data
irs_inflow <- read.csv("./Data/IRS/IRSOriginalData/2021_IRS_County_InflowsNoSummaries.csv")  %>% 
    filter(dest_statefips == 48) # keep only rows who moved into texas
irs_outflow <- read.csv("./Data/IRS/IRSOriginalData/2021_IRS_County_OutflowsNoSummaries.csv")  %>% 
...
# write_csv(inflow, "./IRSMigration/Results/Summaries/2021_inflow.csv")
# write_csv(outflow, "./IRSMigration/Results/Summaries/2021_outflow.csv")
