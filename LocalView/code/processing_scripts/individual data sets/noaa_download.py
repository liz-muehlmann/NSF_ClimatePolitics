...
parent_dir = "C:/Users/Bortimus/Desktop/"                                ## change this to the path where you want to save the files
directory = "test_noaa"                                                  ## change this to whatever you want the folder to be called
