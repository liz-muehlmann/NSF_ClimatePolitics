...
rm(cdp, ip, ipcdp, sample_ipcdp, countySub, countiesGeo, states_abbr, statesGeo)
...
## 2004-2024
## n = 947,226 Unique Events
## n = 196,113 Unique Episodes
noaa_episodeCountyLevel <- files %>% 
...
## n = 132,671
noaa_county <- noaa_episodeCountyLevel %>% 
...
## n = 63,442 rows use zone codes instead of county fips
## n = 84,678 counties within those zones
## n = 84,189 unique episode and counties
noaa_zones <- noaa_episodeCountyLevel %>% 
...
# save(noaa_episodeCountyLevel, file = "./LocalView/data/modified/individual_datasets/noaa_episodeCountyLevel.rdata")
...
# save(noaa_countyLevel, file = "./LocalView/data/modified/individual_datasets/noaa_countyLevel.rdata")
