...
lv <- lvRaw %>% 
    ...
    mutate(place_fips = ifelse(place_fips == "5151650", "5135000", place_fips), # hampton city, VA
           ...
           place_fips = ifelse(place_name == "Gadsden city", "0128696", 
                               place_fips),
           meeting_date = make_date(transcript_year, transcript_month, transcript_day)) %>%                                 # does not have fips
...
# save(lvClean_transcript, file = "./LocalView/data/modified/individual_datasets/lvClean_transcript.rdata")
...
# save(lvClean_noTranscript, file = "./LocalView/data/modified/individual_datasets/lvClean_noTranscript.rdata")
...
# save(lv_countyLevel_noNA, file = "./LocalView/data/modified/individual_datasets/lv_countyLevel_noNA.rdata")
...
# save(lv_countyLevel_withNA, file = "./LocalView/data/modified/individual_datasets/lv_countyLevel_withNA.rdata")
