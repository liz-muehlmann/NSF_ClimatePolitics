...
load("./LocalView/data/modified/individual_datasets/lv_countyLevel_withNA.rdata")
load("./LocalView/data/modified/individual_datasets/cvi_county.rdata")
load("./LocalView/data/modified/individual_datasets/fema_countyLevel.rdata")
load("./LocalView/data/modified/individual_datasets/acs.rdata")
load("./LocalView/data/modified/individual_datasets/algara.rdata")
load("./LocalView/data/modified/individual_datasets/rural_urban.rdata")
...
# save(allData_countyLevel_withNA, file = "./LocalView/data/modified/merged_datasets/allData_countyLevel_withNA.rdata")
