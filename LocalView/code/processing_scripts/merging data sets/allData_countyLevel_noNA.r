...
load("./LocalView/data/modified/individual_datasets/lv_countyLevel_noNA.rdata")
...
# save(allData_countyLevel_noNA, file = "./LocalView/data/modified/merged_datasets/allData_countyLevel_noNA.rdata")
