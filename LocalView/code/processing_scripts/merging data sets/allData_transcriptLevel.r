...
source("./LocalView/code/processing_scripts/individual data sets/geography.r")          # county data
load("./LocalView/data/modified/individual_datasets/lvClean_noTranscript.rdata")        # local view
load("./LocalView/data/modified/individual_datasets/cvi_county.rdata")                  # CVI
load("./LocalView/data/modified/individual_datasets/acs.rdata")                         # ACS
load("./LocalView/data/modified/individual_datasets/algara.rdata")                      # elections
load("./LocalView/data/modified/individual_datasets/rural_urban.rdata")                 # rural-urban
load("./LocalView/data/modified/merged_datasets/lvFema_transcriptLevel.rdata")          # FEMA
load("./LocalView/data/modified/merged_datasets/lvNoaa_transcriptLevel.rdata")          # NOAA
