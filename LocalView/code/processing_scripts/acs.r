### file description ###############################################################################
##                                                                                                ##
## This file handles the processing steps necessary for the American Community Survey             ##
##      Data included:                                                                            ##
...
for(y in acs_years) {
    df <- get_acs(geography = "county", year = y, geometry = FALSE, variables = acs_vars) %>% 
        select(-moe) %>% 
