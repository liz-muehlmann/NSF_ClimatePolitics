################################################################################
##                                                                            ##      
## This file creates a choropleth of county population for the US and         ##
##      texas for 2021                                                        ##  
##                                                                            ##
...
library(tidycensus)             # population
library(RColorBrewer)           # colors
library(htmlwidgets)            # map add ins
...
### subset #####################################################################
##                                                                            ##
##                    subset texas from national data                         ##
##                                                                            ##
################################################################################
...
## save TX map
# saveWidget(tx_map, file="./Maps/2022_TXCountyPopulation.html")